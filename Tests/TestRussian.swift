...
final class TestRussian: XCTestCase {
    ...
    func test_russian() {
        ...
        XCTAssertEqual(russian.read(101), "стo один")
        ...
        XCTAssertEqual(russian.read(11_111), "одиннадцать тысяч стo одиннадцать")
        XCTAssertEqual(russian.read(12_000), "двенадцать тысяч")
        XCTAssertEqual(russian.read(19_000), "девятнадцать тысяч")
        XCTAssertEqual(russian.read(20_000), "двадцать тысяч")
        XCTAssertEqual(russian.read(21_000), "двадцать одна тысяча")
        XCTAssertEqual(russian.read(22_000), "двадцать две тысячи")
        XCTAssertEqual(russian.read(23_000), "двадцать три тысячи")
        XCTAssertEqual(russian.read(24_000), "двадцать четыре тысячи")
        XCTAssertEqual(russian.read(25_000), "двадцать пять тысяч")
        XCTAssertEqual(russian.read(23_456), "двадцать три тысячи четыреста пятьдесят шесть")
        XCTAssertEqual(russian.read(41_000), "сорок одна тысяча")
        XCTAssertEqual(russian.read(99_999), "девяносто девять тысяч девятьсот девяносто девять")
        XCTAssertEqual(russian.read(100_000), "стo тысяч")
        XCTAssertEqual(russian.read(101_000), "стo одна тысяча")
        XCTAssertEqual(russian.read(101_111), "стo одна тысяча стo одиннадцать")
...
//        XCTAssertEqual(russian.read(100_000_000), "стo миллионов")
        XCTAssertEqual(russian.read(101_101_101), "стo один миллион стo одна тысяча стo один")
        ...
        XCTAssertEqual(russian.read(10_000_000_000_000), "десять триллионов")
    }
}
